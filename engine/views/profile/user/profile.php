<div class="container rounded bg-white mt-5 mb-5">
    ...
    <form id="update-profile-form" action="/profile/update">
            ...
            <div class="col-md-4">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="changePasswordCheckbox" type="checkbox" id="changePasswordCheckbox" value="">
        ...
        <div class="row">
            <hr>
            <div align="right">
                <button class="btn btn-primary profile-button" id="update-user" type="submit" disabled>Изменить</button>
                <button class="btn btn-danger" id="delete-profile" data-id="<?= $id ?>"
                        data-token="<?= $registration_token ?>" type="button">Удалить
                </button>
            </div>
        </div>
    </form>
